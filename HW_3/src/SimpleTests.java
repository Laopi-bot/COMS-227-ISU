...
public class SimpleTests {
	public static void main(String args[]) throws FileNotFoundException {
		...
		ConnectGame game = new ConnectGame(5, 8, 1, 4, new Random(0));
		...
		//for loop rescan line and string
		//for load, create file, scan it, nextInit or nextInt, may not need two scanners
		//don't do new line because itll create two new lines
		//use strings 
		//loop through grid to save all the levels for save
		//use two scanners to scan the stuff
